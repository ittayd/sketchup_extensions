...
module Ittay
  module Extensions
    ...
    unless file_loaded?(__FILE__)
      ...
      ex = SketchupExtension.new('Ittay\'s Extensions', 'ittay_extensions/main')
      ...
      # extensions.
      ex.description = 'Several of my extensions, primarily: Rotate a selection to create an isometric view in parallel projection'
      ex.version     = '1.0.0'
