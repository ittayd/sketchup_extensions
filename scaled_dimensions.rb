...
module Ittay
  module ScaledDimensions
    ...
    unless file_loaded?(__FILE__)
      ...
      ex = SketchupExtension.new('Scaled Dimensions', 'scaled_dimensions/main')
      ...
      # extensions.
      ex.description = 'Scaling dimensions so the value shown is multiplied by a factor. Good when the geometry needs to be scaled, but we want the dimensions before scaling. Also option to offset dimensions by an edge. Good when rotating a group and adding dimensions externally to it'
      ex.version     = '1.0.0'
      ex.copyright   = 'Ittay Dror © 2017'
      ex.creator     = 'Ittay Dror'
